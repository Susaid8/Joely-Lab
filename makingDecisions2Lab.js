 ...
 switch(letterGrade){
   case 'A':
    ...
    case 'F':
      ...
      break;
      default:
        console.log("Not an elegible grade.")
 }
...
/* The famous FizzBuzz, Devmountain style!
  ...
  In this for loop, using some conditional logic, if the number your for loop is currently on is divisible by 3, 
  console.log 'Dev'. If the number is divisible by 5, console.log 'mountain'. 
  If the number is divisible by 5 & 3, console.log 'Devmountain'. If the number is not divisible by 5 or 3, 
